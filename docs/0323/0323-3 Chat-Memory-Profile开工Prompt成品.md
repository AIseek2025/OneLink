# Chat -> Memory -> Profile 开工 Prompt 成品

基于 Opus 4.6 二轮验收通过后的 prompt 初稿，由 GPT 5.4 补充完善。

修订内容：

- 新增缺失的 **Prompt 3（GPT 5.4 跨服务收口）**
- Prompt 1（Composer 2）补入 `dispatch-sheet`、`07-ENGINEERING-RULES`、`cargo check` 硬要求、改动区域补全
- Prompt 2（Composer 2 fast）补入 `api-gateway: 8080`、`dispatch-sheet`、`cargo check` 硬要求
- Prompt 4（Opus 验收）补入自身 `review-brief`、`dispatch-sheet`、`07-ENGINEERING-RULES`
...
4. /Users/surferboy/.openclaw/workspace/OneLink/Rules/20-FIRST-RUNNABLE-VERTICAL-SLICE-BRIEF.md
5. /Users/surferboy/.openclaw/workspace/OneLink/Rules/15-MVP-OPENAPI-DRAFT.md
6. /Users/surferboy/.openclaw/workspace/OneLink/Rules/16-MVP-EVENT-SCHEMAS-DRAFT.md
7. /Users/surferboy/.openclaw/workspace/OneLink/Rules/17-MVP-SERVICE-CONTRACTS.md
8. /Users/surferboy/.openclaw/workspace/OneLink/Rules/07-ENGINEERING-RULES.md
...
7. /Users/surferboy/.openclaw/workspace/OneLink/Rules/15-MVP-OPENAPI-DRAFT.md
8. /Users/surferboy/.openclaw/workspace/OneLink/Rules/16-MVP-EVENT-SCHEMAS-DRAFT.md
9. /Users/surferboy/.openclaw/workspace/OneLink/Rules/17-MVP-SERVICE-CONTRACTS.md
10. /Users/surferboy/.openclaw/workspace/OneLink/Rules/20-FIRST-RUNNABLE-VERTICAL-SLICE-BRIEF.md
11. /Users/surferboy/.openclaw/workspace/OneLink/Rules/07-ENGINEERING-RULES.md
...
3. OpenAPI / README / 测试壳一致性
   - Composer 2 fast 同步的 identity-service.yaml / profile-service.yaml / bff.yaml 是否与 Composer 2 实际实现的接口行为一致
...
| 位置 | 修订内容 |
|---|---|
| Prompt 1 阅读清单 | 新增第 8 项 `chat-memory-profile-dispatch-sheet.md`，原第 12 项 `07-ENGINEERING-RULES.md` 移到第 13 项 |
| Prompt 1 改动区域 | 新增 `repo/services/ai-chat-service/` 和 `repo/services/context-service/` 的明确说明 |
| Prompt 1 | 新增"工程硬要求"段：`cargo check` 必须通过，不引入新的 clippy deny 级 warning |
| Prompt 2 阅读清单 | 新增第 3 项 `chat-memory-profile-dispatch-sheet.md`，新增第 8 项 `07-ENGINEERING-RULES.md` |
| Prompt 2 端口矩阵 | 新增 `api-gateway: 8080` |
| Prompt 2 | 新增"工程硬要求"段：`cargo check` 和脚本可执行 |
| **Prompt 3** | **全新：GPT 5.4 跨服务收口 prompt，覆盖 5 类检查清单、收口动作、禁止事项** |
| Prompt 4 阅读清单 | 新增第 6 项 `opus-chat-memory-profile-review-brief.md`，新增第 7 项 `chat-memory-profile-dispatch-sheet.md`，新增第 11 项 `07-ENGINEERING-RULES.md` |
| Prompt 4 审查项 | 新增 `cargo check` 和 `07-ENGINEERING-RULES` 违规检查 |
