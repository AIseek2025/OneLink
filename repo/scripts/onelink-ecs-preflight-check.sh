...
for key in ONELINK_ENV INTERNAL_SHARED_SECRET DATABASE_URL IDENTITY_SERVICE_BASE_URL PROFILE_SERVICE_BASE_URL AI_CHAT_SERVICE_BASE_URL QUESTION_SERVICE_BASE_URL MATCH_SERVICE_BASE_URL SAFETY_SERVICE_BASE_URL DM_SERVICE_BASE_URL MODEL_GATEWAY_BASE_URL CONTEXT_SERVICE_BASE_URL BFF_BASE_URL APP_PORT CORS_ALLOWED_ORIGINS DEEPSEEK_BASE_URL DEEPSEEK_MODEL DEEPSEEK_API_KEY; do
  require_env_key "$key"
done
