...
## 对外接口
见 `repo/platform/contracts/openapi/bff.yaml` 与 `OneLink/docs/archive/rules-legacy-2026-05-15/Rules/15-MVP-OPENAPI-DRAFT.md` §10（`/api/v1/bff/*`）。
...
历史依据：`OneLink/docs/archive/rules-legacy-2026-05-15/Rules/10-SERVICE-BOUNDARIES.md`, `OneLink/docs/archive/rules-legacy-2026-05-15/Rules/15-MVP-OPENAPI-DRAFT.md`
