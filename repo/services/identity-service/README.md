...
## 拥有的数据
`users`, `identity_bindings`, `sessions`, `verification_attempts`（见 `OneLink/docs/archive/rules-legacy-2026-05-15/Rules/14-MVP-SQL-SCHEMA-DRAFT.md` §3.1）。
...
历史依据：`OneLink/docs/archive/rules-legacy-2026-05-15/Rules/10-SERVICE-BOUNDARIES.md`, `OneLink/docs/archive/rules-legacy-2026-05-15/Rules/11-DATA-EVENT-MODEL.md`, `OneLink/docs/archive/rules-legacy-2026-05-15/Rules/15-MVP-OPENAPI-DRAFT.md`
