...
CREATE UNIQUE INDEX idx_profile_facts_user_fact_key ON profile_facts(user_id, fact_key);
...
CREATE UNIQUE INDEX idx_profile_traits_user_type_key ON profile_traits(user_id, trait_type, trait_key);
